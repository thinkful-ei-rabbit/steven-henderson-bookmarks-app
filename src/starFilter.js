...
function filterSetting(power) {
  ...
  if(result == 1) {
    console.log('Filter is set to 1');
  } if(result == 2) {
    console.log('Filter is set to 2');
  } if(result == 3) {
    console.log('Filter is set to 3');
  } if(result == 4) {
    console.log('Filter is set to 4');
  } if(result == 5) {
    console.log('Filter is set to 5');
  };
};
